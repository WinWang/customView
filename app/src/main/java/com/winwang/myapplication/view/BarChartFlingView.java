...
/**
 * Created by WinWang on 2021/4/17
 * Description->
 */
public class BarChartFlingView extends View{
    ...
    public BarChartFlingView(Context context) {
        this(context, null, 0);
    }

    public BarChartFlingView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public BarChartFlingView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
